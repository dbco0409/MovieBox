...
<input type="text" name="reach" id="reach" size="66" style="height:36px; padding: 8px 11px; margin: 3px;"><img src="img/reach.gif" border="0"><img src="img/1_1w.gif" border="0" style="margin-bottom:-1px;margin-left:2px;">
</td>
</tr>
    <tr>
        <td height="10" valign="bottom" width="640">
            <p align="left">&nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_all.jsp">전체</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_2.jsp">영화관</a>&nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_3.jsp">할인/신용카드</a>&nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_4.jsp">멤버십</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_5.jsp">영화예매</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_6.jsp">홈페이지</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_7.jsp">인재채용</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_8.jsp">기타</a></p>
        </td>
    </tr>
 ...
 String DB_URL="jdbc:mysql://localhost:3306/project4";
	 ...
	 Class.forName("org.gjt.mm.mysql.Driver");  
 	 Connection con = DriverManager.getConnection(DB_URL, DB_ID, DB_PASSWORD); 
		...
		String jsql = "select count(*) from faq where ctg='기타'";
     ...
     String jsql2 = "select * from faq  where ctg='기타'";   
