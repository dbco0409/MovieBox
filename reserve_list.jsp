...
var the_height=document.getElementById('request').contentWindow.document.body.scrollHeight; 
document.getElementById('request').height=the_height; } 
</script>
                       ...
                       <table width="673" cellpadding="0" cellspacing="0" align="center" height="633">
                            ...
                            <tr>
                                <td width="700" height="568" id="form" valign="top">
                                    <p><iframe name="request" frameborder="no" src="admin_list_all.jsp" width="700" scrolling="no" onLoad="changeHeight();"></iframe></p>
                                </td>
                            </tr>
