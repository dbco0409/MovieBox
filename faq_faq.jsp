...
<table width="666">
                ...
                <tr>
                    <td width="663" valign="top" style="margin-left:20px"><br>&nbsp;</br><pre><%=content%></pre><br>&nbsp;</br></td>
                </tr>
				<%   
	   }
	    rs.close();
                    ...
                    <td width="663" height="64" style="background-image:url('img/gray_v.gif') background-repeat:no-repeat;" >
                        <table width="620" height="60" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td width="464">&nbsp;</td>
                                <td width="78">
                                    <p><a href="faq_list_all.jsp"><img src="img/list_b.gif" width="77" height="29" border="0"></p>
                                </td>
                                <td width="78"><a href="1_1_write.jsp"><img src="img/replay.gif" width="72" height="25" border="0"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
...
<iframe name="view" frameborder="no" src="faq_view_list.jsp" width="700" scrolling="no" onLoad="changeHeight();"></iframe>
<p>&nbsp;</p>
</body>
