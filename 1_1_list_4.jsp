...
<p>&nbsp;&nbsp;| &nbsp;&nbsp;<a href="1_1_list_all.jsp" Onclick="this.style.color='#662e91';this.style.fontWeight ='bold'">전체</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="1_1_list_1.jsp" Onclick="this.style.color='#662e91';this.style.fontWeight ='bold'">문의사항</a>&nbsp;&nbsp;| &nbsp;&nbsp;<a href="1_1_list_2.jsp" Onclick="this.style.color='#662e91';this.style.fontWeight ='bold'">제안/건의</a>&nbsp;&nbsp;| &nbsp;&nbsp;<a href="1_1_list_3.jsp" Onclick="this.style.color='#662e91';this.style.fontWeight ='bold'">불만사항</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="1_1_list_4.jsp" Onclick="this.style.color='#662e91';this.style.fontWeight ='bold'"><span>칭찬/격려</span></a></p>
</td>
 </tr>
  <tr>
	...
	request.setCharacterEncoding("euc-kr");
	 ...
	 Class.forName("org.gjt.mm.mysql.Driver");  
 	 Connection con = DriverManager.getConnection(DB_URL, DB_ID, DB_PASSWORD); 
		...
		String jsql = "select count(*) from 1_1 where ctg='칭찬/격려'";
     ...
     String jsql2 = "select * from 1_1 where ctg='칭찬/격려'";   
