...
<table align="center" width="625">
    <tr>
        ...
        <td width="37" height="10" valign="bottom" align="left"><a href="faq_write.jsp">등록</a>
        </td>
    </tr>
  <tr>
...
<table width="620" height="43" cellpadding="0" cellspacing="0" align="center" valign="middle" border="0" style="background-image:url('img/list_faq.gif')">
 ...
 <td width="34"><a href="faq_modify.jsp?no=<%=no%>">수정</a></td>
		<td width="34"><a href="faq_delete.jsp?no=<%=no%>"><font color="#8d8d8d">삭제</font></a></td>
</tr>
	</table>
	<%
