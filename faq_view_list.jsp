...
<table align="center">
    ...
    <tr>
        <td height="10" valign="bottom" width="640">
            <p align="left">&nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_all.jsp"  target="_parent">전체</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_2.jsp"  target="_parent">영화관</a>&nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_3.jsp"  target="_parent">할인/신용카드</a>&nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_4.jsp"  target="_parent">멤버십</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_5.jsp"  target="_parent">영화예매</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_6.jsp"  target="_parent">홈페이지</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_7.jsp"  target="_parent">인재채용</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="faq_list_8.jsp"  target="_parent">기타</a></p>
        </td>
    </tr>
...
try {
	request.setCharacterEncoding("euc-kr");
 	 String DB_URL="jdbc:mysql://localhost:3306/movie"; 
     String DB_ID="admin";  
...
<table width="620" height="43" cellpadding="0" cellspacing="0" align="center" valign="middle" border="0" style="background-image:url('img/list_faq.gif')">
 <tr height="20">
        ...
        <td width="86"><%=ctg%></td>
        <td width="488"> <a href="faq_view.jsp?no=<%=no%>" target="_parent"><%=title%></td>
</tr>
	</table>
	<%
