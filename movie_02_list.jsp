...
<%
 ...
 String DB_URL="jdbc:mysql://localhost:3306/project4";
     ...
     String jsql2 = "select * from movie where open='n' order by date";   
...
%>
    ...
    <tr>
        ...
        <td width="43">
            <p><a href="snap.jsp?no=<%=no%>"><img src="img/m_b2.gif" border="0"></p>
        </td>
        <td width="43">
            <p><a href="reserve_write_1.jsp"><img src="img/m_b3.gif" border="0"></a></p>
        </td>
        <td width="43">
