...
<div id="l_1" style="width:890px; height:33px; position:absolute; margin:0 auto;z-index:1; background-image:url('images/line_beg.gif');">
		<form action="faq_reach.jsp" method="post">
		<table cellpadding="0" cellspacing="0" background="images/line_beg.gif">
                    <tr>
				<td width="35"></td>
                    <td width="39"><a href="faq_list_all.jsp"><img src="images/click9.gif" border="0" id="submenu9" /></a></td>
                    ...
                    <td width="28"><a href="in14.jsp"><img src="images/sub14.gif" border="0" id="submenu14" /></a></td>
                        <td width="27"><img src="images/bar_sub.gif" width="27" height="26" border="0" /></td>
                        <td width="28"><a href="1_1_write.jsp"><img src="images/sub15.gif" border="0" id="submenu15" /></td>
                    </tr>
            </table></div></td>
    </tr>
    <tr>
                ...
                <table width="160" cellpadding="0" cellspacing="0" align="center">
                    <tr>
                        <td width="182" height="200" valign="top">
                            <p style="margin-top:10px;"><a href="faq_list_all.jsp"><img src="images/c_9.gif" width="53" height="18" border="0" id="menu9"></a></p>
                            ...
                            <p style="margin-top:10px;"><a href="1_1_write.jsp"><img src="images/s_15.gif" width="69" height="18" border="0" id="menu15"></a></p>
...
<table width="673" cellpadding="0" cellspacing="0" align="center">
    <tr>
                        ...
                        <table width="673" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="673" height="42" valign="top">
                                    <p><img src="img/faq.gif" width="670" height="33" border="0"></p>
                                </td>
                            </tr>
                        </table>
        ...
        <td height="55"  valign="top">
            <p align="center"><input type="text" name="reach" id="reach" size="66" style="height:36px; padding: 8px 11px; margin: 3px;"><a href="faq_reach.jsp"><img src="img/reach.gif" border="0" onClick="submit()"></a> <a href="1_1_write.jsp"><img src="img/1_1w.gif" border="0" style="margin-bottom:-1px;margin-left:2px;"></a>
</p>
        </td>
</tr>
                            <tr>
                                <td width="700" id="form" valign="top">
                                    <p>
</form>
