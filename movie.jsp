...
<table width="890" cellpadding="0" cellspacing="0" align="center" >
 ...
 <table width="192" height="100%" cellpadding="0" cellspacing="0" style="background-image:url('images/right_bar.gif')">
                            ...
                            <table width="160" cellpadding="0" cellspacing="0" align="center">
                                <tr>
                                    <td width="182" height="80" valign="top">
                                        <p><a href="movie_01_list.jsp" onclick="CH3('4');CH4()"target="content"><img src="images/c_4.gif" width="95" height="20" border="0" id="menu4"></p>
                                        <p><a href="movie_02_list.jsp" onclick="CH3('5')"target="content"><img src="images/s_5.gif" width="106" height="19" border="0" id="menu5"></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        <td valign="top" width="720" height="800" align="center">
		<iframe id='content' name='content' frameborder=0 width="890" scrolling="no" src="movie_01_list.jsp" onLoad="changeHeight()">
</iframe>
</td>
</tr>
</table>
