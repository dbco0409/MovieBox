                                ...
                                <td width="490" colspan="2"  valign="top">
                                 <table width="490" cellpadding="0" cellspacing="0" align="center">
                                        <tr>
											...
											<div style="padding:10px; width:200px; height:236px; border:2px solid #662e91; position:relative; overflow:auto">
<%
...
String jsql = "select * from reserve_adm where okay = 'y'";
  ...
  %>
  <a href="reserve_where.jsp?reserve_no=<%=reserve_no%>" OnClick="na_show_layer('sub');na_hide_layer('main')" target="content"><img src="img/<%=level%>.gif" border="0"><%=subject%></a></p>
  <% } %>
  </div>
                                            </td>
