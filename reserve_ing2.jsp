...
<td width="141" height="350" valign="top"> 
	  <table width="141" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td width="141" height="27">½Ã°£: <%=timeArr[tim]%></td>
                                </tr>
                                <tr>
    ...
    <tr>
        <td width="120" align="center"><a href="reserve_write_3.jsp?reserve_no=<%=reserve_no%>&where=<%=where%>&date=<%=days%>&time=<%=tim%>&people=<%=people%>&sit=<%=sit%>&price=<%=price%>" target="_parent"><font color="white"><b>NEXT ¢º</b></font></td>
    </tr>
</table>
                        </td>
						 </table>
