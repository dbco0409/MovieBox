...
<html><head><title>notice 전체 문의</title>
<style type="text/css">
...
<table align="center">
    <tr>
        <td height="10" valign="bottom" width="540">
            <p align="left">&nbsp;&nbsp;| &nbsp;&nbsp;<a href="notice_list_all.jsp">전체</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="notice_list_1.jsp">영화관 공지</p>
        </td>
 ...
 String DB_URL="jdbc:mysql://localhost:3306/project4";
	 ...
	 Class.forName("org.gjt.mm.mysql.Driver");  
 	 Connection con = DriverManager.getConnection(DB_URL, DB_ID, DB_PASSWORD); 
		...
		String jsql = "select count(*) from notice where ctg='영화관 공지'";
     ...
     String jsql2 = "select * from notice where ctg='영화관 공지'";   
...
<table width="620" height="30" cellpadding="0" cellspacing="0" align="center" valign="middle" border="0">
 <tr height="20">
        ...
        <td width="100"><%=ctg%></td>
        <td width="488"> <a href="notice_view.jsp?no=<%=no%>" Onclick="this.style.color='#662e91';this.style.fontWeight ='bold'"><%=title%></td>
        <td width="65"><%=date%></td>
</tr>
	</table>
