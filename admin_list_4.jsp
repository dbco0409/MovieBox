...
<table align="center">
    <tr>
        <td height="10" valign="bottom" width="640">
            <p align="left">&nbsp;&nbsp;| &nbsp;&nbsp;<a href="admin_list_all.jsp" >FAQ</a>&nbsp;&nbsp;| &nbsp;&nbsp;<a href="admin_list_2.jsp" >공지사항</a>&nbsp;&nbsp;| &nbsp;&nbsp;<a href="admin_list_3.jsp" >예매/취소내역</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="admin_list_4.jsp" >1:1문의</a></p>
        </td>
    </tr>
...
<img src="img/gray_bar.gif" border="0">
   ...
   %>
		...
		%>
        <a href="admin_list_4.jsp?group_index=0"  ><img src="img/first.gif" border="0"/></a>
        &nbsp;&nbsp;&nbsp;
   ...
   <%
			...
			{
   %>
       <a href="admin_list_4.jsp?group_index=<%= j-1 %>"  ><img src="img/page_<%= j %>.gif" border="0"/></a>
   <%
            }
       }
   ...
   %>
	  ...
	  <%
	   ...
	   %>
      <a href="admin_list_4.jsp?group_index=<%= cntList_1 - 1 %>"  ><img src="img/end.gif" border="0"/></a>
