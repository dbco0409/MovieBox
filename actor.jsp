...
<td width="233">평가하기 : <select name="cht">
    ...
    <tr>
        ...
        <td width="145" bgcolor="#6D3A99" onclick=location.href="actor.jsp?no=<%=no%>">
            <p align="center"><a href="actor.jsp?no=<%=no%>"><font color="white">배우/감독</font></a></p>
        </td>
        <td width="10">
            <p align="center">|</p>
        </td>
...
<tr><td><div style="width:680px; height:100%; position:absolute; z-index:1; margin:0 auto;">
<%
...
%>
    ...
    <tr>
        <td width="230"><font color="black"><b><%=name%></b></font></td>
    </tr>
    <tr>
