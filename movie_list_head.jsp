...
a:link,a:visited{text-decoration:none; color: #8d8d8d; font-size:10pt;}
...
<body bgcolor="white" text="black" link="blue" vlink="purple" alink="red" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0">
 <%
  ...
  String  jsql2 = "select * from movie_snap where no =?";
     ...
     rs2.next();
           String image11 = rs2.getString("image1");
		   String image22 = rs2.getString("image2");
		    String image33 = rs2.getString("image3");

	String[]  image01 = image11.split(",");   
	String[]  image02 = image22.split(",");  
	String[]  image03 = image33.split(",");  	
...
<td width="233">평가하기 : <select name="cht">
    ...
    <tr>
        <td width="145" bgcolor="#ffffff" onclick=location.href="movie_view.jsp?no=<%=no%>">
            <p align="center"><a href="movie_view.jsp?no=<%=no%>">주요정보</a></p>
        </td>
        <td width="10">
            <p align="center">|</p>
        </td>
        <td width="145" bgcolor="#ffffff" onclick=location.href="actor.jsp?no=<%=no%>">
            <p align="center"><a href="actor.jsp?no=<%=no%>">배우/감독</font></a></p>
        </td>
        <td width="10">
            <p align="center">|</p>
        </td>
...
<%@include file="movie_chart_list.jsp"%>
