...
<td height="35"  valign="top">
    ...
    <tr>
        <td height="10" valign="bottom" width="640">
            <p align="left">&nbsp;&nbsp;| &nbsp;&nbsp;<a href="notice_list_all.jsp">전체</a> &nbsp;&nbsp;| &nbsp;&nbsp;<a href="notice_list_1.jsp">영화관 공지</a></p>
        </td>
    </tr>
...
<table width="620" height="30" cellpadding="0" cellspacing="0" align="center" valign="middle" border="0">
 <tr height="20">
        ...
        <td width="100"><%=ctg%></td>
        <td width="488"> <a href="notice_view.jsp?no=<%=no%>" target="_parent" Onclick="this.style.color='#662e91';this.style.fontWeight ='bold'"><%=title%></td>
        <td width="65"><%=date%></td>
</tr>
	</table>
	<%
