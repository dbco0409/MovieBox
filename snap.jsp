...
<td width="233">평가하기 : <select name="cht">
    ...
    <tr>
        ...
        <td width="145" bgcolor="#6D3A99" onclick=location.href="snap.jsp?no=<%=no%>">
            <p align="center"><a href="snap.jsp?no=<%=no%>"><font color="white">스틸컷</a></p>
        </td>
        <td width="10">
            <p align="center">|</p>
        </td>
        <td width="145" bgcolor="#ffffff" onclick=location.href="movie_list_head.jsp?no=<%=no%>">
            <p align="center"><a href="movie_list_head.jsp?no=<%=no%>">리뷰</a></p>
				...
				<p align="center"><img id="show_img" src="<%=image%>">
</p>
		
				<p><table width="700" cellpadding="0" cellspacing="0" align="center">
    <tr>
        <td width="128"><img src="<%=image01[0]%>" border="0" width="100" height="64"onclick="change_img(this.src)">
</a>&nbsp;</td>
        <td width="128"><img src="<%=image01[1]%>" border="0" width="100" height="64" onclick="change_img(this.src)">
</a>&nbsp;</td>
        <td width="128"><img src="<%=image02[0]%>" border="0" width="100" height="64" onclick="change_img(this.src)">
</a>&nbsp;</td>
        <td width="128"><img src="<%=image02[1]%>" border="0" width="100" height="64" onclick="change_img(this.src)">
</a>&nbsp;</td>
        <td width="128"><img src="<%=image03[0]%>" border="0" width="100" height="64" onclick="change_img(this.src)">
</a>&nbsp;</td>
        <td width="128"><img src="<%=image03[1]%>" border="0" width="100" height="64" onclick="change_img(this.src)">
</a>&nbsp;</td>
    </tr>
</table></p>
