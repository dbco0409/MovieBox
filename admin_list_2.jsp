...
<table width="620" height="43" cellpadding="0" cellspacing="0" align="center" valign="top" border="0" style="background-image:url('img/list_faq.gif')">
 <tr height="20">
        ...
        <td width="34"><a href="notice_modify.jsp?no=<%=no%>">수정</a></td>
		<td width="34"><a href="notice_delete.jsp?no=<%=no%>"><font color="#8d8d8d">삭제</font></a></td>
</tr>
	</table>
	<p>
	<%
