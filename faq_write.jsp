...
<p>&nbsp;</p>
<form name="form" method="post" action="faq_write_result.jsp">
                            ...
                            <table width="530" cellpadding="0" cellspacing="0" align="center" height="433">
                                ...
                                <tr>
									...
									<tr>
									 <tr  align="right">
                                    <td width="510" height="15" rowspan="2" valign="top"><img src="img/submit.gif" onClick="check_val()"><a href="admin_list_2.jsp" target="list"><img src="img/cut.gif" border="0"></a></td>
									</tr>
