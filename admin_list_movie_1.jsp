...
request.setCharacterEncoding("euc-kr");
	 ...
	 Class.forName("org.gjt.mm.mysql.Driver");  
 	 Connection con = DriverManager.getConnection(DB_URL, DB_ID, DB_PASSWORD); 
		...
		String jsql = "select count(*) from movie where open='y'";
     ...
     String jsql2 = "select * from movie where open='y'";   
...
<table width="620" height="43" cellpadding="0" cellspacing="0" align="center" valign="middle" border="0" style="background-image:url('img/list_faq.gif')">
 ...
 <td width="35"><a href="movie_modify_01.jsp?no=<%=no%>">수정</a></td>
   ...
   %>
		...
		%>
        <a href="admin_list_movie_1.jsp?group_index=0"><img src="img/first.gif" border="0"/></a>
        &nbsp;&nbsp;&nbsp;
   ...
   <%
			...
			{
   %>
       <a href="admin_list_movie_1.jsp?group_index=<%= j-1 %>"><img src="img/page_<%= j %>.gif" border="0"/></a>
   <%
            }
       }
   ...
   %>
	  ...
	  <%
	   ...
	   %>
      <a href="admin_list_movie_1.jsp?group_index=<%= cntList_1 - 1 %>"><img src="img/end.gif" border="0"/></a>
